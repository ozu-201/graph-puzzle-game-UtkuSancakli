...
int main() {
    ...
    std::fstream newFile;
    newFile.open("C:\\Users\\TEMP.OZUN.000\\CLionProjects\\graph-puzzle-game-UtkuSancakli\\dic", std::ios::in);
    ...
    */
    ...
    int from = get_index(v3, "ayı");

    int to = get_index(v3,"aba");

    Path* p = graph3.dijkstra(from, to, v3);
